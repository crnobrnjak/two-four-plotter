...
export const CITE_DOI_LABEL =
  "https://onlinelibrary.wiley.com/doi/10.1111/ter.70031";

export const CONTACT_TEXT = "Contact me at:";

export const CONTACT_EMAIL = "kostacrn (at) gmail (dot) com";
